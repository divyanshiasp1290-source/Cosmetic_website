...
export const services: Service[] = [
  ...
  },
  {
    ...
    benefits: ["Reduces pigmentation and sun damage", "Improves skin texture", "Evens out skin tone", "Reveals brighter, healthier-looking skin"],
    result: "Many patients notice brighter, smoother skin within a few days. Results continue to improve over the following weeks as your skin naturally renews itself.",
    image: svcPeel,
  },
  {
    slug: "ipl-treatments",
    ...
    benefits: ["Reduces pigmentation and sunspots", "Minimises redness", "Evens out skin tone", "Improves overall skin clarity"],
    result: "Many patients notice clearer, brighter skin after a few sessions. For the best results, a series of 3–5 treatments may be recommended, depending on your skin concerns.",
    image: svcIpl,
  },
  {
  ...
  },
  {
    ...
    benefits: ["Deeply cleanses and hydrates the skin", "Helps minimise the appearance of pores", "Improves skin texture and radiance", "No downtime required"],
    result: "Your skin will look cleaner, smoother, and more radiant immediately after treatment, making it a great choice before a special event.",
  ...
  },
  {
    ...
    benefits: ["Helps reduce inflammation", "Supports faster skin healing", "Clears clogged pores and congestion", "Promotes a brighter, healthier complexion"],
    result:
  ...
  },
  {
    ...
    benefits: ["Smooths rough skin texture", "Brightens dull skin", "Helps minimise the appearance of pores", "Leaves skin feeling soft and refreshed"],
    result: "Many patients notice smoother, brighter skin after just one treatment. A series of sessions can provide even better, longer-lasting results.",
    image: svcMicroderm,
  },
  {
    slug: "face-sculpt",
    ...
    result: "You'll notice a more refreshed and defined appearance after treatment. Results continue to improve over time and vary depending on your personalised treatment plan.",
  ...
  },
  {
    ...
    benefits: ["Leaves skin smooth and soft", "Brightens dull skin", "Improves skincare product absorption", "Creates a smooth base for makeup"],
    result: "You'll notice smoother, brighter skin immediately after treatment with no downtime. Monthly treatments can help maintain long-lasting results.",
  ...
  },
  {
    ...
    result: "Many patients notice calmer, healthier-looking skin after a few sessions. Regular treatments can help improve skin clarity, texture, and overall appearance over time.",
    image: svcLed,
  },
];
